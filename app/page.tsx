  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 lg:p-8">
              ...
              <p className="text-gray-500 text-sm mb-6">Connect with a licensed NZ broker — no obligation, no spam.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Four specialist covers designed for the specific risks NZ content creators face — from gear theft to brand deal disputes.
            </p>
          </div>
      ...
      <section className="bg-gradient-hero text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-4">Insurance for Every Type of Creator</h2>
            <p className="text-lg text-purple-200">Whether you&apos;re on Instagram, YouTube, TikTok, Twitch or podcasting — we have NZ cover specialists for your platform.</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                <div className="text-sm font-medium text-purple-100">{creator.label}</div>
              </Link>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                Why NZ Creators Use Influencer Insurance NZ
              </h2>
                ...
                {[
                  {
                    ...
                    desc: "We connect you with NZ brokers who understand the creator economy — not generalists who have never heard of brand deals or account hijacking.",
                  },
                  {
                    icon: "🏅",
                    title: "Licensed NZ advisers only",
                  ...
                  },
                  {
                    ...
                    desc: "Our brokers compare options from multiple NZ insurers to find you the most competitive premium for the cover you need.",
                  },
                ].map((item) => (
      ...
      <section className="bg-purple-900 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-4">
            NZ&apos;s Fair Trading Act Applies to You
          </h2>
          <p className="text-purple-200 leading-relaxed mb-6 max-w-2xl mx-auto">
            The Commerce Commission actively monitors NZ influencer content for compliance. Undisclosed sponsored posts, misleading product claims and unlabelled affiliate content can attract fines up to $200,000 per offence under the Fair Trading Act 1986. Professional indemnity insurance is your financial backstop.
          </p>
          <Link
      ...
      <section className="bg-gradient-brand text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-purple-100 text-lg mb-8">
            Connect with a licensed NZ insurance adviser today. Your enquiry is handled confidentially and you will receive a personalised response within one business day.
          </p>
          <Link
            href="/quote/"
